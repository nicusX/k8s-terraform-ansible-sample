...
Please see the companion articles https://opencredo.com/kubernetes-aws-terraform-ansible-1/ explain the goal and some of the design decisions taken.
...
- No fixed internal or external DNS naming (only dynamic DNS names, generated by AWS)
